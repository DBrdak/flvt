    ...
    return (
        <div className="loader" style={{width: width, height:'auto'}}>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="498"
                ...
                <g className={'element element element element1'} clip-path="url(#5c0bbf9857)">
                    <path fill="#027af2"
                ...
                <g className={'element element2'} clip-path="url(#f42672f8c9)">
                    <path fill="#027af2"
                ...
                <g className={'element element7'} clip-path="url(#08a261494e)">
                    <path fill="#002952"
                ...
                <g className={'element element8'} clip-path="url(#1c138e1d8a)">
                    <path fill="#002952"
