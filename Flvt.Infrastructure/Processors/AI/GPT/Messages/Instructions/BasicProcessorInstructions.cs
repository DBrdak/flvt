...
internal sealed class BasicProcessorInstructions
{
    ...
    private const string priceInstruction = 
        "Price - provide the price of the apartment plus any mentioned constant costs. Do not include variable costs (e.g. electricity) and optional costs (e.g. parking). Do include rent to the housing association in this field.";
