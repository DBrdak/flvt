...
internal sealed class BasicProcessorInstructions
{
    ...
    private const string contactTypeInstruction = "ContactType - copy the contact type from the previous advertisement and standarize it, to \"real estate agency\" or \"private\" but translated to the original advertisement languange";
