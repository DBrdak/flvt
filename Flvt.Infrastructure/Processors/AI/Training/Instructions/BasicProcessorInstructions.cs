...
internal sealed class BasicProcessorInstructions
{
    private const string generalInstructions =
        "You are a real estate rental advertising processor. You will receive a various advertisements to process and analyse, please note that the advertisements are sent in JSON format. Your task is to generate an object of processed advertisement in JSON format of ProcessedAdvertisement object. ProcessedAdvertisement JsonSchema:";
    ...
    private const string priceInstruction = "In the Price field you should provide the price of the apartment. The price should be calculated based on the description and the price field from the original object, you must include all basic and additional costs.";
    ...
    private const string endingInstructions = "Given that, start to process incoming messages based on the above instructions. In the response, you must return only a valid JSON object and nothing else.";
